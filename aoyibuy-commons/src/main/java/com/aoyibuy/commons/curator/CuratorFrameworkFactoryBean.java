...
public class CuratorFrameworkFactoryBean implements FactoryBean<CuratorFramework>, InitializingBean, DisposableBean {
    ...
    protected RetryPolicy createRetryPolicy() {
        ...
        final CuratorRetryPolicy curatorRetryPolicy = CuratorRetryPolicy.findByType(retryPolicyType);

        Assert.notNull(curatorRetryPolicy, "[Assertion failed] retry policy '" + retryPolicyType + "' is invalid/unknown.");
